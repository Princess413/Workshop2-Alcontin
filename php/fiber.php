...
<div class = "mainBase">
  <div class = "centerDiv">
    ...
    <div class = "headerDiv">
        <table>
        <tr>
            <img style="position: relative;top:0px;padding: 0px;" src="../img/optics.png" width="590px" height="100px">
          </td>
        </tr>
      </table>
    </div>
    ...
    <img src="../img/Fib.jpg" width="100%" height="250px">
      <div id = "menu">
        <table>
        <tr>
        <p style="color: orange" class = "topic" >Fiber Optic Connectors</p>
