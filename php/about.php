...
<div class = "mainBase">
	<div class = "centerDiv">
		...
		<img src="../img/cod.jpg" width="100%" height="250px">
			<div id = "menu">
				<table>
				<tr>
				<p style="color: orange" class = "topic" >Network Hardware and Peripherals</p>
					
							</tr>

					<tr>
						<td><img src="../img/hs.png" width="200px" height="auto"></td>
						<td>
							<p style="color: orange" class = "foodName" >Switches and Hubs</p>
							<p style = "color: orange;"
							>
								An Ethernet hub, active hub, network hub, repeater hub, multiport repeater, or simply hub is a network hardware device for connecting multiple Ethernet devices together and making them act as a single network segment. It has multiple input/output (I/O) ports, in which a signal introduced at the input of any port appears at the output of every port except the original incoming.[1] A hub works at the physical layer (layer 1) of the OSI model.[2] A repeater hub also participates in collision detection, forwarding a jam signal to all ports if it detects a collision.</p>
								<p style = "color: orange;">
					...
					<tr>
						...
						<td>
							<p style="color: orange" class = "foodName" >Unshielded Twisted Pair (UTP) Cable</p>
							<p style = "color: orange;">
					...
					<tr>
						<td><img src="../img/rj.jpg" width="200px" height="auto"></td>
						<td>
							<p style="color: orange" class = "foodName" >RJ-45</p>
							<p style = "color: orange;">
					...
					<tr>
						<td><img src="../img/crimp.jpg" width="200px" height="auto"></td>
						<td>
							<p style="color: orange" class = "foodName" >Crimper</p>
							<p style = "color: orange;">
